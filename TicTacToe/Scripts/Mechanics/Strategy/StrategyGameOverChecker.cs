...
{
    public static class StrategyGameOverChecker
    {
        //todo unit test
        public static void GameOverCheck(StrategyBoard<ETttType> board, int columns, int rows, int length,
        ...
        private static Vector3Int[] GameOverCheckType(ETttType type, StrategyBoard<ETttType> board, int columns,
            int rows, int length)
        {
            ...
            if (CheckDio(board, false, length, out indices, type))
            {
                return indices;
            }

            if (CheckDio(board, true, length, out indices, type))
            {
                return indices;
            }
        ...
        private static bool CheckDio(StrategyBoard<ETttType> board, bool secondary, int length,
        ...
        private static bool CheckDraw(StrategyBoard<ETttType> board)
        {
            var width = board.StrategyColumns;
            var height = board.StrategyRows;
